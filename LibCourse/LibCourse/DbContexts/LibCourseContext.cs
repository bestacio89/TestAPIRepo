...
namespace LibCourse.API.DbContexts
{
    public class LibCourseContext : DbContext
    {
        public LibCourseContext(DbContextOptions<LibCourseContext> options)
           : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Course>().HasData(
               ...
               new Course
               {
                   ...
                   Description = "In this course, the Person provides tips to avoid, or, if needed, overthrow pirate mutiny."
               },
               new Course
               {
