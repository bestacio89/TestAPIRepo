...
namespace LibCourse.APIMigrations
{
    [DbContext(typeof(LibCourseContext))]
    partial class LibCourseContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibCourse.APIEntities.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LibCourse.APIEntities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PersonId = new Guid("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                        ...
                        new
                        {
                            ...
                            PersonId = new Guid("da2fd609-d754-4feb-8acd-c4f9ff13ba96"),
                        ...
                        new
                        {
                            ...
                            PersonId = new Guid("2902b665-1190-4c70-9915-b9c2d7680450"),
            ...
            modelBuilder.Entity("LibCourse.APIEntities.Course", b =>
                {
                    b.HasOne("LibCourse.APIEntities.Person", "Person")
                        .WithMany("Courses")
